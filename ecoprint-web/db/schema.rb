...
ActiveRecord::Schema[7.0].define(version: 2022_11_22_065445) do
  ...
  create_table "delivery_addresses", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["commune_id"], name: "index_delivery_addresses_on_commune_id"
  ...
  create_table "products_transactions", id: false, force: :cascade do |t|
    ...
    t.bigint "product_id"
    t.index ["product_id"], name: "index_products_transactions_on_product_id"
    t.index ["transaction_id"], name: "index_products_transactions_on_transaction_id"
  end
  ...
  add_foreign_key "delivery_addresses", "communes"
