class CommunesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @commune.save
        format.html { redirect_to commune_url(@commune), notice: "Commune was successfully created." }
  ...
  def update
    respond_to do |format|
      if @commune.update(commune_params)
        format.html { redirect_to commune_url(@commune), notice: "Commune was successfully updated." }
